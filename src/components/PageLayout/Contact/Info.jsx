            ...
            <section id="second-section" className="bg-black text-white">
                <div className="container py-[6%] space-y-[7vw]">
                    <div className="w-[90%] mx-auto">
                        <h2 className="text-76 space-grotesk text-center leading-[1.2]">
                            Ready for a Game-Changing Partnership? Let's Shape the Future, Side by Side.
                        </h2>
                    </div>

                    <div className="border-y-[0.5px] border-[#999999] flex w-full justify-center items-center">
                        <div className="text-center w-1/2 border-r-[0.5px] border-[#999] py-[3vw]">
                        ...
                        <div className="text-center w-1/2 border-l-[0.5px] border-[#999] ml-[-0.5px] py-[3vw]">
                    ...
                    <div data-scroll-prevent className="h-[50vh] w-full">
