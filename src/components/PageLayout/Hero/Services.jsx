    ...
    <>
      <section id="services" className="bg-black">
        <div className="container pt-[10%] pb-[5%]">
          ...
          <div className="grid grid-cols-2 grid-rows-3 gap-[1.5vw] mobile:flex mobile:flex-col mobile:mt-[7vh]">
            <div
              ser-slot="1"
                    ...
                    <div className="ser-info-100 mobile:px-[5%] mobile:mt-[2vh]">
                      <div className="ser-info-w">
                        <div className="ser-info-abs">
                          ...
                          <div className="ser-info-group mobile:mt-[2vh]">
                            <Link
                              href="#"
                              className="border block w-fit border-[#4D4D4D] py-[1vw] sec-content-24 px-[2.5vw] rounded-full bg-[#1D1D1D] mobile:px-[7vw] mobile:py-[2vw]"
                            >
                              <span className="uppercase text-white mobile:text-[3vw]">Details</span>
                            </Link>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="ser-info-abs">
                          ...
                          <div className="ser-info-group mobile:mt-[2vh]">
                            <Link
                              ...
                              className="border block w-fit border-[#4D4D4D] py-[1vw] sec-content-24 px-[2.5vw] rounded-full bg-[#1D1D1D]  mobile:px-[7vw] mobile:py-[2vw]"
                            >
                              <span className="uppercase mobile:text-[3vw] text-white">Details</span>
                            </Link>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="ser-info-abs">
                          ...
                          <div className="ser-info-group mobile:mt-[2vh]">
                            <Link
                              ...
                              className="border block w-fit border-[#4D4D4D] py-[1vw] sec-content-24 px-[2.5vw] rounded-full bg-[#1D1D1D] mobile:px-[7vw] mobile:py-[2vw]"
                            >
                              <span className="uppercase text-white">Details</span>
                            </Link>
                          </div>
                        </div>
                      </div>
