                    ...
                    <div className="text-white mb-[4vw]">
                        ...
                        <div className="relative w-[65%]">
                            ...
                            <p className="text-22 w-[40%] absolute top-[62%] para-animations">
                                <span>
                                Dive into a world where design meets strategy, only at Creative Curve.</span>
                            </p>
                        </div>
                    </div>
                            ...
                            <div className="grid grid-cols-2 grid-rows-3 gap-[1.5vw]">
                                ...
                                <div ser-slot="1" className="relative pointer-events-auto z-[99] fadeUp ser-grid-slot is--active col-span-1 col-start-1 row-span-3 row-start-1">
                                                ...
                                                <div className="ser-info-100">
                                                    <div className="ser-info-w">
                                                        <div className="ser-info-abs">
                                                            ...
                                                            <div className="ser-info-group">
                                                                <Link href="#" className="border block w-fit border-[#4D4D4D] py-[1vw] sec-content-24 px-[2.5vw] rounded-full bg-[#1D1D1D]">
                                ...
                                <div ser-slot="2" className="relative pointer-events-auto z-[99] fadeUp ser-grid-slot col-span-1 col-start-2 row-span-1 row-start-1">
                                ...
                                <div ser-slot="3" className="relative pointer-events-auto z-[99] fadeUp ser-grid-slot col-span-1 col-start-2 row-span-1 row-start-2">
                                    <div  className="ser-grid-item">
                                        <div className="ser-grid-item-div">
                                        <div className="ser-content-w">
                                                <div className="ser-titles-w">
                                ...
                                <div ser-slot="4" className="relative pointer-events-auto z-[99] fadeUp ser-grid-slot col-span-1 col-start-2 row-span-1 row-start-3">
                                    <div  className="ser-grid-item">
                                        <div className="ser-grid-item-div">
                                        <div className="ser-content-w">
                                                <div className="ser-titles-w">
