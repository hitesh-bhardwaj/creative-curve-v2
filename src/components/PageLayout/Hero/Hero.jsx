                ...
                <div className="container h-dvh flex justify-center items-center hero-container mobile:items-center mobile:max-w-full">
                    ...
                    <h1 className="title-h1">
                        <div className="text-24 aeonik text-left ml-[5vw]  text-anim overflow-hidden mobile:text-center mobile:ml-0">
                            <span ref={small} className="w-[110%] relative leading-10 mobile:after:hidden after:absolute after:top-1/2 after:ml-2 after:-translate-y-1/2 after:bg-current after:h-[1.5px] after:w-[1.5vw] block mobile:w-full">
                                We Creative Curve</span>
                        </div>
                    ...
                    <div className="uppercase text-24 text-textBody mobile:mt-[9vh]">
                         <span className=" relative after:absolute after:bg-current after:w-full after:h-[2px] after:block after:scale-x-100 cursor-pointer hover:after:scale-x-0 after:duration-300 after:ease-out after:left-0">Scroll Down</span>
                    </div>
