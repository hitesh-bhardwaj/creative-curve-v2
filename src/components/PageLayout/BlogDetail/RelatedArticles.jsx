                ...
                <Link href={link} className="w-full relative h-fit group/blog">
                    ...
                    <p className="uppercase flex items-center group gap-[10px] mt-[1vw] mobile:mt-[2vh]">
                        ...
                        <span className="relative w-fit overflow-hidden rotate-[-45deg]">
                            <img className="w-[1.2vw] h-[1.2vw] -translate-x-[120%] scale-0 group-hover:translate-x-0 group-hover:scale-100 transition-all duration-300 ease-out mobile:w-[4vw] mobile:h-[4vw]" alt="arrow-icon" src="/images/icons/arrow-right.svg"/>
                            <img className="w-[1.2vw] h-[1.2vw] absolute right-0 top-0 transition-all duration-300 ease-out group-hover:scale-0 group-hover:translate-x-[120%] mobile:w-[4vw] mobile:h-[4vw]" alt="arrow-icon" src="/images/icons/arrow-right.svg"/>
                        </span>
                    </p>
                </Link>
            ...
            <section>
                <div className="container py-[8%] mobile:py-[20%]">
                    <div className="flex justify-between items-end mb-[5vw] mobile:flex-col mobile:items-start">
                        <h2 className="text-140 leading-[1] space-grotesk text-textHead w-[50%] mobile:text-[10vw] mobile:w-full">
                            <span>Related </span>
                            <span>Articles</span>
                        </h2>
