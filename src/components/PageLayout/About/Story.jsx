                    ...
                    <div className="container pb-[10vw] ">
                        <div className="story-main text-white">
                            <div className="accordion space-y-[2vw]">
                                ...
                                <div className="flex justify-between px-[1vw] mobile:flex-col">
                                    <div className="w-[40%] space-y-[1.5vw] mobile:w-full">
                                    ...
                                    <div className="w-[40%] h-[20vw] overflow-hidden rounded-xl border border-white/50 mobile:w-full mobile:h-[60vw] mobile:flex mobile:justify-center mobile:mt-[5vh] ">
                                        <Image 
                                            className="object-cover object-top h-full w-full mobile:w-full"
                            ...
                            <div className="accordion space-y-[2vw]">
                                <span className="w-full block border-b border-dashed border-white/50" />
                                <div className="flex justify-between px-[1vw] mobile:flex-col">
                                    <div className="w-[40%] space-y-[1.5vw] mobile:w-full mobile:mt-[5vh]">
                                        <h3 className="text-44">
                                    ...
                                    <div className="w-[40%] h-[20vw] overflow-hidden rounded-xl border border-white/50 mobile:w-full mobile:h-[60vw]  mobile:justify-center mobile:mt-[5vh] mobile:hidden">
                                        <Image 
