...
const ScrollButton = () => {
    ...
    return (
        <>
            <div data-cursor-size="60px" data-cursor-exclusion onClick={handleSmoothScroll} className="scroll-btn uppercase cursor-pointer text-24 mb-2 text-textBody mobile:order-2 mobile:absolute mobile:bottom-[20%] mobile:left-[30%]">
