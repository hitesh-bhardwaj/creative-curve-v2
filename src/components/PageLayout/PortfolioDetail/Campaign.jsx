    ...
    return (
        <>
            <section id="campaign" className={`${className}`} data-cursor-exclusion>
                <div className="container py-[7%] mobile:py-[20%] tablet:py-[15%]">
                    <div className="flex justify-start items-center gap-[5vw] mobile:flex-col mobile:items-start">
                        ...
                        <p className="w-[20vw] text-24 pt-[1.5vw] mobile:w-[80vw] para-animations tablet:w-[40vw]">
                            {secSubHead}
                        </p>
                    </div>
                    <div className="mt-[5vw] mobile:flex mobile:flex-col mobile:mt-[15vw] tablet:mt-[10vw]">
                        ...
                        <div className="grid grid-cols-6 gap-y-[6vw] mobile:flex mobile:flex-col">
                            ...
                            <div className="col-span-4 relative h-[35vw] border-4 border-black rounded-[40px] overflow-hidden mobile:h-[25vh] mobile:rounded-[20px] mobile:mt-[2vh] mobile:border-2 tablet:col-span-3 tablet:h-[20vh] tablet:rounded-[15px]">
                            ...
                            <div className="col-span-2 flex items-center pl-[22%] mobile:pl-0 mobile:my-[5%] tablet:col-span-3">
                            ...
                            <div className="col-span-4 relative h-[35vw] border-4 border-black rounded-[40px] overflow-hidden mobile:h-[25vh] mobile:rounded-[20px] mobile:mt-[2vh] mobile:border-2 tablet:h-[25vh] tablet:rounded-[15px]">
