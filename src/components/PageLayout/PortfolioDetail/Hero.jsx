        ...
        <>
            <section id="hero">
                <div className="h-[85vh] relative">
                    ...
                    <div className="container relative z-[1] flex text-center items-center flex-col justify-center h-full w-full">
                        ...
                        <div className="flex justify-between w-full absolute bottom-[15%]">
                            <div className="uppercase text-24 text-white">
                            ...
                            <p className="text-24 text-white text-right w-[25vw]">
