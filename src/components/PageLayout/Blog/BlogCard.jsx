...
const BlogCard = ({ title, category, img, link }) => {
    ...
    return (
        <div className="col-span-1 blog-card h-full fadeUp">
            <Link href={link} className="w-full relative h-fit group/blog">
                ...
                <p className="uppercase flex items-center group gap-[10px] mt-[2vw] mobile:mt-[2vh]">
                    <span className="text-[1.55vw] relative after:block after:absolute after:bottom-0 after:left-0 after:w-full after:h-[1px] after:bg-textHead after:transition-all after:duration-300 after:ease-out hover:after:scale-x-0 mobile:text-[4vw] tablet:text-[2.3vw]">
                        Read More
                    </span>
                    <span className="relative w-fit overflow-hidden rotate-[-45deg]">
                        <img className="w-[1.5vw] h-[1.5vw] -translate-x-[120%] scale-0 group-hover:translate-x-0 group-hover:scale-100 transition-all duration-300 ease-out mobile:w-[4vw] mobile:h-[4vw] tablet:w-[3vw] tablet:h-[3vw]" alt="arrow-icon" src="/images/icons/arrow-right.svg"/>
                        <img className="w-[1.5vw] h-[1.5vw] absolute right-0 top-0 transition-all duration-300 ease-out group-hover:scale-0 group-hover:translate-x-[120%] mobile:w-[4vw] mobile:h-[4vw] tablet:w-[3vw] tablet:h-[3vw]" alt="arrow-icon" src="/images/icons/arrow-right.svg"/>
                    </span>
                </p>
            </Link>
        </div>
