        ...
        <>
            <Link scroll={false} href={link} className="leading-[2] flex group overflow-hidden relative items-center justify-between uppercase">
                ...
                <div className="w-[1vw] h-fit text-black overflow-hidden mobile:w-[5vw] mobile:h-[5vw]">
                    <div className="w-[200%] gap-[5%] flex items-center translate-x-[-55%] group-hover:translate-x-[0] transition-all duration-500 ease-out">
                        <Image 
                            className="w-[1vw] mobile:w-[5vw] mobile:h-[5vw]"
