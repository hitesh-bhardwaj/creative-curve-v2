...
const Content = ({children}) => {
    ...
    return( 
        <>
            <div className="flex items-end justify-center container pt-[4%] pb-[2%] tablet:pt-[10%] tablet:pb-[5%] footer-container h-full">
                        ...
                        <div className="col-span-2 col-start-10 tablet:col-span-3 tablet:col-start-8 mobile:flex mobile:flex-col mobile:w-full mobile:items-center mobile:mt-[4vh]">
                            ...
                            <ul className="text-white space-y-[1vw] text-[1.25vw] mobile:text-[5vw] mobile:mt-[1.5vh] mobile:flex mobile:flex-col mobile:gap-[1.2vh] tablet:text-[3.2vw] tablet:space-y-[2vw">
                                <li className="mobile:flex mobile:justify-center">
                                    <Link data-cursor-size="60px" href="/about" className="leading-[1.4] w-fit block group overflow-hidden">
                                ...
                                <li className=" mobile:flex mobile:justify-center">
                                    <Link data-cursor-size="60px" href="/contact" className="leading-[1.4] w-fit block group overflow-hidden">
                                ...
                                <li className=" mobile:flex mobile:justify-center">
                                    <Link data-cursor-size="60px" href="/services" className="leading-[1.4] w-fit block group overflow-hidden">
                                ...
                                <li className=" mobile:flex mobile:justify-center">
                                    <Link data-cursor-size="60px" href="/blog" className="leading-[1.4] w-fit block group overflow-hidden">
